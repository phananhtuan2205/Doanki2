 ...
 * @author TranHung
 */
public class frmSearch_GV extends javax.swing.JFrame {
    ...
    public frmSearch_GV(pnDiemTheoLop pn) {
        initComponents();
        DiemTheoLop = pn;
    ...
    public frmSearch_GV(pnThongKe pn) {
        initComponents();
        ThongKe = pn;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Search Giảng Viên");
    ...
    private void tbl_GVMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_GVMouseClicked
        ...
        //lay ra dong select
        row = tbl_GV.getSelectedRow();
        GiangVien gv = listGV.get(row);

        if (Diem!=null) {
            Diem.receiveGV(gv);
            
        } else if (DiemTheoLop!=null) {
            DiemTheoLop.receiveGV(gv);
        }
        else if(ThongKe!=null){
            ThongKe.receiveGV(gv);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmSearch_GV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmSearch_GV().setVisible(true);
            }
        });
    }
    ...
    private void initTable() {
        ...
        tbl_data.addColumn("Tên GV");
        tbl_data.addColumn("SĐT");
