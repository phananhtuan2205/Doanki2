 ...
 * @author TranHung
 */
public class frmSearch_Lop extends javax.swing.JFrame {
    ...
    /**
     * Creates new form frmSearch_Lop
     */
    public frmSearch_Lop() {
        initComponents();
    ...
    public frmSearch_Lop(pn_SV_Lop pn) {
        initComponents();
        SV_Lop = pn;
    ...
    public frmSearch_Lop(pnDiemTheoLop pn) {
        initComponents();
        DiemTheoLop = pn;
    ...
    public frmSearch_Lop(pnThongKe pn) {
        initComponents();
        ThongKe = pn;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Nhập tên hoặc ID");
    ...
    private void tbl_LopMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_LopMouseClicked
        ...
        //lay ra dong select
        row = tbl_Lop.getSelectedRow();
        Lop lop = listLop.get(row);
        
        if (SV_Lop != null) {
            SV_Lop.receiveLop(lop);
            
        }else if (DiemTheoLop != null) {
            DiemTheoLop.receiveLop(lop);
            
        }else if (ThongKe!=null) {
            ThongKe.receiveLop(lop);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmSearch_Lop.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmSearch_Lop().setVisible(true);
            }
        });
    }
